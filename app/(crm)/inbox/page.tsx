...
export default function InboxPage() {
  return (
    <div style={{ padding: '28px 32px 56px' }}>
      <div style={{ fontSize: 26, fontWeight: 700, letterSpacing: '-0.02em', marginBottom: 8 }}>Inbox</div>
      <div className="card" style={{ padding: 48, textAlign: 'center', marginTop: 24 }}>
        ...
        <div style={{ fontSize: 16, fontWeight: 600 }}>Inbox próximamente</div>
        <div style={{ color: 'var(--muted)', fontSize: 13, marginTop: 6 }}>Integración con email disponible próximamente.</div>
