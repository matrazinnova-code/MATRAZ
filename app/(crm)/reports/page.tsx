...
export default function ReportsPage() {
  return (
    <div style={{ padding: '28px 32px 56px' }}>
      <div style={{ fontSize: 26, fontWeight: 700, letterSpacing: '-0.02em', marginBottom: 8 }}>Reportes</div>
      <div className="card" style={{ padding: 48, textAlign: 'center', marginTop: 24 }}>
        ...
        <div style={{ color: 'var(--muted)', fontSize: 13, marginTop: 6 }}>Los reportes estarán disponibles próximamente.</div>
